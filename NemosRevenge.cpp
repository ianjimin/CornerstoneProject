...
// Function to wrap up the game with a final message guiding players
//
// to the aquarium model
void concludeGame() {
...
int main()
{
   ...
   designChoices();
   concludeGame()
   ; // Call the new function to conclude the game with final instructions
   return 0;
}
